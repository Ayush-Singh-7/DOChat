...
<body>
    <header class="header">
        ...
        <div class="logo">
            <div class="heading">
                <a href="welcome.html">Search Doctors</a>
            </div>
            <div class="sub">
        ...
        <nav class="nav grid-3 center pad0">
            ...
            <div class="left_border padadj">
                <form action="searchrel.php" method="POST" >
                    <input type="text" name="name" id="msearch" placeholder="Search Doctor">
    ...
    <?php
        ...
        if($conn->query($sql))
        {
            ...
            if($result->num_rows>0)
            {
                ...
                {
                   echo "<div>";
                   echo "<form method='POST' action='doctordata.php'>";
